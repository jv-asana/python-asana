        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PortfolioCompact']:
                        return PortfolioCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PortfolioCompact'], typing.List['PortfolioCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PortfolioCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class GetPortfolios(BaseApi):
    ...
    def get_portfolios(
        ...
        return self._get_portfolios_oapg(
