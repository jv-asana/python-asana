        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['GoalCompact']:
                        return GoalCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['GoalCompact'], typing.List['GoalCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'GoalCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_parent_goals_for_goal_oapg(
        self,
...
class GetParentGoalsForGoal(BaseApi):
    ...
    def get_parent_goals_for_goal(
        ...
        return self._get_parent_goals_for_goal_oapg(
