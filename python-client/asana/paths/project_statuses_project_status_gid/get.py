...
# Path params
ProjectStatusGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'project_status_gid': typing.Union[ProjectStatusGidSchema, str, ],
    }
)
...
request_path_project_status_gid = api_client.PathParameter(
    name="project_status_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProjectStatusGidSchema,
    required=True,
)
_auth = [
    'oauth2',
...
class BaseApi(api_client.Api):
    ...
    def _get_project_status_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_project_status_gid,
        ):
...
class GetProjectStatus(BaseApi):
    ...
    def get_project_status(
        ...
        return self._get_project_status_oapg(
