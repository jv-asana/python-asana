        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SectionCompact']:
                        return SectionCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SectionCompact'], typing.List['SectionCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'SectionCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sections_for_project_oapg(
        self,
...
class GetSectionsForProject(BaseApi):
    ...
    def get_sections_for_project(
        ...
        return self._get_sections_for_project_oapg(
