...
# Path params
ProjectMembershipGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'project_membership_gid': typing.Union[ProjectMembershipGidSchema, str, ],
    }
)
...
request_path_project_membership_gid = api_client.PathParameter(
    name="project_membership_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProjectMembershipGidSchema,
    required=True,
)
_auth = [
    'oauth2',
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ProjectMembershipResponse']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ProjectMembershipResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['ProjectMembershipResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        data: typing.Union['ProjectMembershipResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_membership_oapg(
        self,
    ...
    def _get_project_membership_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_project_membership_gid,
        ):
...
class GetProjectMembership(BaseApi):
    ...
    def get_project_membership(
        ...
        return self._get_project_membership_oapg(
