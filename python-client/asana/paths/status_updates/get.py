        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['StatusUpdateCompact']:
                        return StatusUpdateCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['StatusUpdateCompact'], typing.List['StatusUpdateCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'StatusUpdateCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_statuses_for_object_oapg(
        self,
...
class GetStatusesForObject(BaseApi):
    ...
    def get_statuses_for_object(
        ...
        return self._get_statuses_for_object_oapg(
