        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TeamCompact']:
                        return TeamCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TeamCompact'], typing.List['TeamCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TeamCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_teams_for_workspace_oapg(
        self,
...
class GetTeamsForWorkspace(BaseApi):
    ...
    def get_teams_for_workspace(
        ...
        return self._get_teams_for_workspace_oapg(
