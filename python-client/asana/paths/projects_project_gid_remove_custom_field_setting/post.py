...
class BaseApi(api_client.Api):
    @typing.overload
    def _remove_custom_field_setting_for_project_oapg(
        self,
...
class RemoveCustomFieldSettingForProject(BaseApi):
    ...
    def remove_custom_field_setting_for_project(
        ...
        return self._remove_custom_field_setting_for_project_oapg(
            body=body,
