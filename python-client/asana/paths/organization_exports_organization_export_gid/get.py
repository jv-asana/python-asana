...
# Path params
OrganizationExportGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'organization_export_gid': typing.Union[OrganizationExportGidSchema, str, ],
    }
)
...
request_path_organization_export_gid = api_client.PathParameter(
    name="organization_export_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=OrganizationExportGidSchema,
    required=True,
)
_auth = [
    'oauth2',
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_organization_export_oapg(
        self,
    ...
    def _get_organization_export_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_organization_export_gid,
        ):
...
class GetOrganizationExport(BaseApi):
    ...
    def get_organization_export(
        ...
        return self._get_organization_export_oapg(
