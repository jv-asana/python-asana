...
# Path params
TeamMembershipGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'team_membership_gid': typing.Union[TeamMembershipGidSchema, str, ],
    }
)
...
request_path_team_membership_gid = api_client.PathParameter(
    name="team_membership_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TeamMembershipGidSchema,
    required=True,
)
_auth = [
    'oauth2',
...
class BaseApi(api_client.Api):
    ...
    def _get_team_membership_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_team_membership_gid,
        ):
...
class GetTeamMembership(BaseApi):
    ...
    def get_team_membership(
        ...
        return self._get_team_membership_oapg(
