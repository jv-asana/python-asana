...
# Path params
JobGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'job_gid': typing.Union[JobGidSchema, str, ],
    }
)
...
request_path_job_gid = api_client.PathParameter(
    name="job_gid",
