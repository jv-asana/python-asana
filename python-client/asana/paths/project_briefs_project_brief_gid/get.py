...
# Path params
ProjectBriefGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'project_brief_gid': typing.Union[ProjectBriefGidSchema, str, ],
    }
)
...
request_path_project_brief_gid = api_client.PathParameter(
    name="project_brief_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProjectBriefGidSchema,
    required=True,
)
_auth = [
    'oauth2',
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ProjectBriefResponse']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ProjectBriefResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['ProjectBriefResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        data: typing.Union['ProjectBriefResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
...
SchemaFor402ResponseBodyApplicationJson = ErrorResponse
...
SchemaFor424ResponseBodyApplicationJson = ErrorResponse


@dataclass
class ApiResponseFor424(api_client.ApiResponse):
    response: urllib3.HTTPResponse
    body: typing.Union[
        SchemaFor424ResponseBodyApplicationJson,
    ]
    headers: schemas.Unset = schemas.unset


_response_for_424 = api_client.OpenApiResponse(
    response_cls=ApiResponseFor424,
    content={
        'application/json': api_client.MediaType(
            schema=SchemaFor424ResponseBodyApplicationJson),
    },
)
...
SchemaFor501ResponseBodyApplicationJson = ErrorResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_project_brief_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_project_brief_gid,
        ):
...
class GetProjectBrief(BaseApi):
    ...
    def get_project_brief(
        ...
        return self._get_project_brief_oapg(
