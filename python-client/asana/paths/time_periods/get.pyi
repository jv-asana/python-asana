        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TimePeriodCompact']:
                        return TimePeriodCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TimePeriodCompact'], typing.List['TimePeriodCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TimePeriodCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class GetTimePeriods(BaseApi):
    ...
    def get_time_periods(
        ...
        return self._get_time_periods_oapg(
