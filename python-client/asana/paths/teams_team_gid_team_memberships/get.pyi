        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TeamMembershipCompact']:
                        return TeamMembershipCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TeamMembershipCompact'], typing.List['TeamMembershipCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TeamMembershipCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_team_memberships_for_team_oapg(
        self,
...
class GetTeamMembershipsForTeam(BaseApi):
    ...
    def get_team_memberships_for_team(
        ...
        return self._get_team_memberships_for_team_oapg(
