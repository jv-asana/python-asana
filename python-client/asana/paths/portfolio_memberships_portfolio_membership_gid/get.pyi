...
# Path params
PortfolioMembershipGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'portfolio_membership_gid': typing.Union[PortfolioMembershipGidSchema, str, ],
    }
)
...
request_path_portfolio_membership_gid = api_client.PathParameter(
    name="portfolio_membership_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PortfolioMembershipGidSchema,
    required=True,
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['PortfolioMembershipCompact']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'PortfolioMembershipCompact': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['PortfolioMembershipCompact', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        data: typing.Union['PortfolioMembershipCompact', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_membership_oapg(
        self,
    ...
    def _get_portfolio_membership_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_portfolio_membership_gid,
        ):
...
class GetPortfolioMembership(BaseApi):
    ...
    def get_portfolio_membership(
        ...
        return self._get_portfolio_membership_oapg(
