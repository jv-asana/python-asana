...
class ResourceTypeSchema(
    ...
    @schemas.classproperty
    def PROJECT_TEMPLATE(cls):
        return cls("project_template")
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AsanaNamedResource']:
                        return AsanaNamedResource
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AsanaNamedResource'], typing.List['AsanaNamedResource']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'AsanaNamedResource':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _typeahead_for_workspace_oapg(
        self,
...
class TypeaheadForWorkspace(BaseApi):
    ...
    def typeahead_for_workspace(
        ...
        return self._typeahead_for_workspace_oapg(
