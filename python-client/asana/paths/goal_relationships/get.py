        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['GoalRelationshipCompact']:
                        return GoalRelationshipCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['GoalRelationshipCompact'], typing.List['GoalRelationshipCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'GoalRelationshipCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_goal_relationships_oapg(
        self,
...
class GetGoalRelationships(BaseApi):
    ...
    def get_goal_relationships(
        ...
        return self._get_goal_relationships_oapg(
