...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_custom_field_settings_for_portfolio_oapg(
        self,
...
class GetCustomFieldSettingsForPortfolio(BaseApi):
    ...
    def get_custom_field_settings_for_portfolio(
        ...
        return self._get_custom_field_settings_for_portfolio_oapg(
