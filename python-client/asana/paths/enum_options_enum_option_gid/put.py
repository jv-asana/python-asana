...
# Path params
EnumOptionGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'enum_option_gid': typing.Union[EnumOptionGidSchema, str, ],
    }
)
...
request_path_enum_option_gid = api_client.PathParameter(
    name="enum_option_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EnumOptionGidSchema,
    required=True,
)
# body param
...
class UpdateEnumOption(BaseApi):
    ...
    def update_enum_option(
        ...
        return self._update_enum_option_oapg(
            body=body,
