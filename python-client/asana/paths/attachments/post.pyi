...
# body param
SchemaForRequestBodyMultipartFormData = AttachmentRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_attachment_for_object_oapg(
        self,
...
class CreateAttachmentForObject(BaseApi):
    ...
    def create_attachment_for_object(
        ...
        return self._create_attachment_for_object_oapg(
            body=body,
