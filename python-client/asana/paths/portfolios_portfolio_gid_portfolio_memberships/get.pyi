        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PortfolioMembershipCompact']:
                        return PortfolioMembershipCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PortfolioMembershipCompact'], typing.List['PortfolioMembershipCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PortfolioMembershipCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_portfolio_memberships_for_portfolio_oapg(
        self,
...
class GetPortfolioMembershipsForPortfolio(BaseApi):
    ...
    def get_portfolio_memberships_for_portfolio(
        ...
        return self._get_portfolio_memberships_for_portfolio_oapg(
