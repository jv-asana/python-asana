        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['StoryCompact']:
                        return StoryCompact
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['StoryCompact'], typing.List['StoryCompact']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'StoryCompact':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_stories_for_task_oapg(
        self,
...
class GetStoriesForTask(BaseApi):
    ...
    def get_stories_for_task(
        ...
        return self._get_stories_for_task_oapg(
