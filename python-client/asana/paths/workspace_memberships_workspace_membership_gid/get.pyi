...
# Path params
WorkspaceMembershipGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'workspace_membership_gid': typing.Union[WorkspaceMembershipGidSchema, str, ],
    }
)
...
request_path_workspace_membership_gid = api_client.PathParameter(
    name="workspace_membership_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=WorkspaceMembershipGidSchema,
    required=True,
)
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['WorkspaceMembershipResponse']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'WorkspaceMembershipResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['WorkspaceMembershipResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        data: typing.Union['WorkspaceMembershipResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workspace_membership_oapg(
        self,
    ...
    def _get_workspace_membership_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_workspace_membership_gid,
        ):
...
class GetWorkspaceMembership(BaseApi):
    ...
    def get_workspace_membership(
        ...
        return self._get_workspace_membership_oapg(
