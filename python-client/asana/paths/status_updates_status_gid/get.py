...
# Path params
StatusGidSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'status_gid': typing.Union[StatusGidSchema, str, ],
    }
)
...
request_path_status_gid = api_client.PathParameter(
    name="status_gid",
    style=api_client.ParameterStyle.SIMPLE,
    schema=StatusGidSchema,
    required=True,
)
_auth = [
    'oauth2',
