...
class PortfolioAddItemRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["item", "insert_before", "insert_after", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["item", "insert_before", "insert_after", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        item: typing.Union[MetaOapg.properties.item, str, ],
