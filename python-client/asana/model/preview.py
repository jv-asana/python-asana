...
This is read-only except for a small group of whitelisted apps.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fallback", "footer", "header", "header_link", "html_text", "text", "title", "title_link", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fallback", "footer", "header", "header_link", "html_text", "text", "title", "title_link", ], str]):
