...
class GoalBase(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "html_notes", "notes", "due_on", "start_on", "status", "is_workspace_level", "liked", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "html_notes", "notes", "due_on", "start_on", "status", "is_workspace_level", "liked", ], str]):
