...
class PortfolioResponse(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["created_at", "created_by", "custom_field_settings", "current_status_update", "due_on", "custom_fields", "members", "owner", "start_on", "workspace", "permalink_url", "public", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["created_at", "created_by", "custom_field_settings", "current_status_update", "due_on", "custom_fields", "members", "owner", "start_on", "workspace", "permalink_url", "public", ], str]):
