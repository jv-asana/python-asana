...
class GoalRemoveSupportingRelationshipRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["supporting_resource", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["supporting_resource", ], str]):
