...
class AuditLogEventResource(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resource_type", "resource_subtype", "gid", "name", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resource_type", "resource_subtype", "gid", "name", "email", ], str]):
