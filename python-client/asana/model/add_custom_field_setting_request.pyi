...
class AddCustomFieldSettingRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["custom_field", "is_important", "insert_before", "insert_after", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["custom_field", "is_important", "insert_before", "insert_after", ], str]):
