...
class GoalResponse(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["likes", "num_likes", "team", "workspace", "followers", "time_period", "metric", "owner", "current_status_update", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["likes", "num_likes", "team", "workspace", "followers", "time_period", "metric", "owner", "current_status_update", ], str]):
                return super().get_item_oapg(name)
