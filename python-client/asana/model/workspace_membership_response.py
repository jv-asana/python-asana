...
class WorkspaceMembershipResponse(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_task_list", "is_active", "is_admin", "is_guest", "vacation_dates", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_task_list", "is_active", "is_admin", "is_guest", "vacation_dates", ], str]):
                return super().get_item_oapg(name)
