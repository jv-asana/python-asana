# asana.model.webhook_compact.WebhookCompact
...
------------ | ------------- | ------------- | ------------- | -------------
**active** | bool,  | BoolClass,  | If true, the webhook will send events - if false it is considered inactive and will not generate events. | [optional] 
**resource** | [**AsanaNamedResource**](AsanaNamedResource.md) | [**AsanaNamedResource**](AsanaNamedResource.md) |  | [optional] 
**target** | str,  | str,  | The URL to receive the HTTP POST. | [optional] 
