...
class Tasks:
    ...
    def search_tasks_for_workspace(self, workspace_gid, params=None, **options):
        ...
        :param Object params: Parameters for the request
            ...
            - due_on {date, none_type}:  ISO 8601 date string or `null`
            ...
            - start_on {date, none_type}:  ISO 8601 date string or `null`
            - created_on_before {date}:  ISO 8601 date string
            - created_on_after {date}:  ISO 8601 date string
            - created_on {date, none_type}:  ISO 8601 date string or `null`
            ...
            - completed_on {date, none_type}:  ISO 8601 date string or `null`
            ...
            - modified_on {date, none_type}:  ISO 8601 date string or `null`
